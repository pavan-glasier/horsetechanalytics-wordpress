...
function horsetechanalytics_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'horsetechanalytics' ),
		)
	);
...
function horsetechanalytics_scripts() {
	...
	wp_enqueue_script( 'horsetechanalytics-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
